    ...
    <div className="space-y-16">
      ...
      <section className="relative min-h-[calc(100vh-6rem)] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/space-background-NRGQvvHIUVnQGIQlnXg9xvf1hrdtk9.jpg"
        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="bg-white/10 backdrop-blur-md border-2 border-yellow-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-yellow-400/20 hover:border-yellow-400 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/0 via-yellow-400/30 to-yellow-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-0"></div>
                <CardHeader>
      ...
      <section className="relative py-16">
        <div className="absolute inset-0 z-0">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/nebula-background-5Xn9lbxDWU3WxEDFBaQxhqQwTmhLBf.jpg"
      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-yellow-400 hover:bg-yellow-500 text-indigo-900 text-lg py-4 px-8 rounded-full transition-all duration-300 animate-pulse">
